...
<html>
	...
	<body class="is-preload" style="background-image:url(images/pic2.jpg);alignment-baseline: stretch;background-repeat: no-repeat;
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<section id="main" class="container medium">
					<header>
						<h2>Contact Us</h2>
						<p>For any enquiries feel free to engage with us.</p>
					</header>
					<div class="box">
