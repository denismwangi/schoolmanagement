...
<?php
 ...
 $fid =$fname =$lname = $nic = $address = $contact = $gender = $email=" ";
              

if(isset($_GET['update'])){
  $update = "SELECT * FROM finance WHERE fid=".$_GET['update']."";
...
<head>
  ...
  <title>Accountant</title><link rel="icon" href="../img/favicon2.png">
...
<div class="wrapper">
 ...
 <?php include_once 'header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Account
        <small>Accountant Details</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Accountant</a></li>
 ...
 <div class="col-xs-4">
         ...
         <div class="alert alert-success alert-dismissible" style="display: none;" id="truemsg">
                ...
                New Accountant Successfully added
              </div>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">New Accountant</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input name="nic" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter NIC" required>
                </div>
 ...
 <div class="form-group">
   ...
   <div class="form-group">
                  ...
                  <input name="contact" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Contact No" required>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-primary">Add Accountant</button>
              </div>
            </form>
              ...
              if (isset($_POST['submit'])) {
                ...
                $contact = $_POST['contact'];
                  ...
                  try {
                    $sql = "INSERT INTO finance (fname,lname,address,contact,nic,email,gender) VALUES ( '".$fname."', '".$lname."','".$address."','".$contact."','".$nic."','".$email."','".$gender."')";
...
x.style.display='block';</script>";
         ...
         <div class="alert alert-success alert-dismissible" style="display: none;" id="truemsg">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-check"></i> Success!</h4>
                Update Accountant Successfully added
              </div>
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                  ...
                  <input name="fid" type="hidden" class="form-control" id="exampleInputPassword1"   required value=<?php echo "'".$fid."'"; ?>>
  ...
  <label style="width: 100px"><input type="radio" name="gender" value="Female" <?php if($gender=='Female'){echo 'checked';} ?>>Female</label>
   ...
   <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-primary">Update Accountant</button>
              </div>
            </form>
     ...
     //            echo $contact;
                  ...
                  try {
                   ...
                   // $sql = "UPDATE finance SET fname='".$fname."',lname='".$lname."',nic='".$nic."',address='".$address."',gender='".$gender.",contact='".$contact."',email='".$email."' WHERE fid =".$fid;


$edit2 =mysqli_query($conn,"UPDATE finance SET fname='$fname', lname='$lname', nic='$nic',
address='$address',gender='$gender', contact='$contact',email='$email' WHERE fid='$fid' ")or die (mysqli_error());
...
x.style.display='block';</script>";
        ...
        <?php } ?>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">All Accontant</h3>
            </div>
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      $fid = $row['fid'];
                      echo "<tr><td> " . $row["fid"]. " </td><td> " . $row["fname"]." ". $row["lname"]. " </td><td> " . $row["nic"]. "</td><td>" . $row["gender"]. "</td><td>" . $row["address"]. "</td><td>" . $row["contact"]. "</td><td><a href='accountant.php?update=". $row["fid"]."'><small class='label  bg-orange'>Update</small></a></td></tr>";
                       }
                                  }
