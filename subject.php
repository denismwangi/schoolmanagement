              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input name="class" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Subject Title" >
                </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Fees</label>
                  <input name="description" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Course Fees" required>
                </div>
              ...
              if (isset($_POST['submit'])) {
                ...
                $description = $_POST['description'];
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO subject (sid,title,class,description) VALUES ( '".$sid."', '".$title."', '".$class."','".$description."')";
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="exampleInputPassword1">Class</label>
                  <input name="class" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Subject Class"  value="<?php //echo $class; ?>">
                </div>

                  <div class="form-group">
                  <label for="exampleInputPassword1">Fees</label>
                  <input name="description" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Subject Fees" required value="<?php echo $description; ?>">
                </div>
              ...
              if (isset($_POST['submit'])) {
                ...
                $description = $_POST['description'];
                  ...
                  try {
                    ...
                    $sql = "UPDATE subject set title='".$title."' ,description='".$description."',class='".$class."' where sid = '".$sid."' " ;
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["sid"]. " </td><td> " . $row["title"]. "</td> <td> " . $row["class"]. " </td><td>" . $row["description"]. "</td><td><a href='subject.php?update=". $row["sid"]."'><small class='label  bg-orange'>Update</small></a></td></tr>";
                       }
                                  }
