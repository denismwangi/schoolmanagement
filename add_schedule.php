         ...
         <div class="alert alert-success alert-dismissible" style="display: none;" id="truemsg">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <button type="submit" class="btn btn-primary" style="margin-left: 330px;"><a href="./schedule.php" style="color:white;">Back</a></button>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <label>Course</label>
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="subject"><option >Select Course</option>
                  <?php
           ...
           <div class="bootstrap-timepicker">
              ...
              <div class="bootstrap-timepicker">
               ...
               <div class="form-group">
                  ...
                  <input name="link" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Link">
                </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Zoom Password</label>
                  <input name="pass" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Password"  >
                </div>
               ...
               // $dob = date_format(new DateTime($_POST['dob']),'Y-m-d');
                ...
                $day = $_POST['day'];
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO schedule (subject,teacher,class,day,stime,etime,link,pass) VALUES ('".$subject."', '".$teacher."', '".$classroom."','".$day."','".$stime."','".$etime."','".$link."','".$pass."')";
