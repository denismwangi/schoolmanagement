	...
	<header id="header" class="alt " style="background-color: black;" >
				...
				<div class="row" style="padding-top: 80px;">
							...
							<section class="box special">
								<h3>CLASS A</h3>
								<span class="image featured"><img src="images/classA.jpg" alt="" /></span>
								<h3>10 lessons</h3>
								<h4>pricing:</h4>
								<div>ksh.14,100</div>
								<span>Refresher course at ksh.1,500 per class</span>
								<!-- <p>Environmental Conservation is one of the longest-standing, most highly-cited of the interdisciplinary environmental science journals. It includes research papers, reports, comments and subject reviews addressing environmental policy, practice, and natural and social science of environmental concern at the global level.</p> -->
							...
							<section class="box special">
								<h3>CLASS B</h3>
								<span class="image featured"><img src="images/classB.jpeg" alt="" /></span>
								<h3>21 lessons</h3>
								<h4>pricing:</h4>
								<div>ksh.18,450</div>
								<h5>Class 'B' Light vehicle </h5>
								<!-- <p>Environmental protection. Environmental protection is the practice of protecting the natural environment by individuals, organizations and governments. Its objectives are to conserve natural resources and the existing natural environment and, where possible, to repair damage and reverse trends</p> -->
								<!-- <ul class="actions special">
									<li><a href="#" class="button alt">Learn More</a></li>
								</ul> -->
							</section>
							...
							<section class="box special">
								<h3>CLASS C</h3>
								<span class="image featured"><img src="images/classC.jpg" alt="" /></span>
								<h3>21 lessons</h3>
								<h4>pricing:</h4>
								<div>ksh.15,350</div>
								<h5>Class 'C'  </h5>
								<!-- <p>Project environment represents a connection, where the project is processed. It impacts the project and is, therefore, conditioned. Such an interaction is provided by numerous factors as operational, physical, ecological, social, cultural, economic, psychological.</p> -->
								<!-- <ul class="actions special">
									<li><a href="#" class="button alt">Learn More</a></li>
								</ul> -->
								</section>
							...
							<section class="box special">
								...
								<span class="image featured"><img src="images/computerpackages.jpg" alt="" /></span>
								<h3>2 months</h3>
								<h4>pricing:</h4>
								<div>ksh.4,500</div>
					...
					<h4 style="text-align: center;"><strong>latest news</strong> </h4>
				<div class="row">
							
							<div class="col-3 col-12-narrower">
							<section class="box special">
								<span class="image featured"><img src="images/award1.jpg" alt="" /></span>
							...
							<div class="col-3 col-12-narrower">
							<section class="box special">
								<span class="image featured"><img src="images/award3.jpg" alt="" /></span>
							...
							<div class="col-3 col-12-narrower">
							<section class="box special">
								<span class="image featured"><img src="images/award4.jpg" alt="" /></span>
